...
module.exports = function(element, bpmnFactory, options, translate) {
  ...
  var canTranslate = !!options.translate && typeof options.translate === 'function';
  ...
  return {
    ...
    get: function(element, node) {
      ...
      forEach(elements, function(elem) {
        ...
        if(canTranslate){
           field_content = options.translate(elem);
        }else{
           field_content = elem.get(modelProperty);
        }

        result.push({
          extensionElementValue: field_content
        });
      });
