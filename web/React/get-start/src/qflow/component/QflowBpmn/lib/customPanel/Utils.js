...
var setDefaultParameters = function(options) {
  ...
  var defaultGet = function(element, node) {
  ...
  var defaultSet = function(element, values, node) {
    var res = {},
        prop = ensureNotNull(options.modelProperty);
    if (values[prop] !== '') {
...
module.exports.setDefaultParameters = setDefaultParameters;

var getTool = function(element, id) {

  var query = '.bpp-properties-tab select#qflow-' + id + '-select';
  return domQuery(query).value;

}

module.exports.getTool = getTool;

var getToolType = function(element, type) {

  var query = '.bpp-properties-tab select#qflow-' + type + '-select';
  return domQuery(query);

}

module.exports.getToolType = getToolType;
