...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/search-pad/SearchPad.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/search-pad/</a> SearchPad.js
    </h1>
    <div class='clearfix'>
...
547
548
549</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  ...
  listen(document, 'html', 'click', function(e) <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >    self.close();</span>
  }, true);
&nbsp;
  // stop event from propagating and closing search
  // focus on input
  listen(this._container, SearchPad.INPUT_SELECTOR, 'click', function(e) <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >    e.stopPropagation();</span>
<span class="cstat-no" title="statement not covered" >    e.delegateTarget.focus();</span>
  });
&nbsp;
  // preselect result on hover
  listen(this._container, SearchPad.RESULT_SELECTOR, 'mouseover', function(e) <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >    e.stopPropagation();</span>
<span class="cstat-no" title="statement not covered" >    self._scrollToNode(e.delegateTarget);</span>
<span class="cstat-no" title="statement not covered" >    self._preselect(e.delegateTarget);</span>
  });
&nbsp;
  // selects desired result on mouse click
  listen(this._container, SearchPad.RESULT_SELECTOR, 'click', function(e) <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >    e.stopPropagation();</span>
<span class="cstat-no" title="statement not covered" >    self._select(e.delegateTarget);</span>
  });
&nbsp;
...
&nbsp;
      return selected ? self._select(selected) : <span class="branch-1 cbranch-no" title="branch not covered" >self.close();</span>
    }
&nbsp;
    // up
    if (e.keyCode === 38) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!pattern || pattern === '') {
...
SearchPad.prototype._scrollToDirection = function(previous) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!selected) {
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
...
SearchPad.prototype._scrollToNode = function(node) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!node || node === this._getCurrentResult()) {
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (nodeOffset &lt; containerScroll) {
<span class="cstat-no" title="statement not covered" >    this._resultsContainer.scrollTop = nodeOffset;</span>
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (containerScroll &lt; bottomScroll) {
<span class="cstat-no" title="statement not covered" >    this._resultsContainer.scrollTop = bottomScroll;</span>
  }
};
&nbsp;
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (result.primaryTokens.length &gt; 0) {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isOpen()) {
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
  this._bindEvents();
...
&nbsp;
  // already selected
  <span class="missing-if-branch" title="if path not taken" >I</span>if (node === selectedNode) {
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
...
&nbsp;
  return htmlText !== '' ? htmlText : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
}
&nbsp;
&nbsp;
/**
