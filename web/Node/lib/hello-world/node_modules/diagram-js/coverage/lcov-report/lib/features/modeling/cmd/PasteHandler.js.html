...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/modeling/cmd/PasteHandler.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/features/modeling/cmd/</a> PasteHandler.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (element) {
<span class="cstat-no" title="statement not covered" >          tree.createdElements[id] = {</span>
            element: element,
...
&nbsp;
      // set host
      <span class="missing-if-branch" title="if path not taken" >I</span>if (element.host) {
<span class="cstat-no" title="statement not covered" >        hints.attach = true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        parent = self._getCreatedElement(element.host, tree);</span>
      }
&nbsp;
      // handle labels
      <span class="missing-if-branch" title="if path not taken" >I</span>if (element.labelTarget) {
<span class="cstat-no" title="statement not covered" >        return tree.labels.push(element);</span>
      }
&nbsp;
      newPosition = {
...
&nbsp;
  var tree = context.tree,
      ...
      topLevelElements = [];
&nbsp;
  forEach(labels, function(labelDescriptor) <span class="fstat-no" title="function not covered" >{</span>
    var labelTarget = <span class="cstat-no" title="statement not covered" >self._getCreatedElement(labelDescriptor.labelTarget, tree),</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    labels = labelTarget.labels;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!labels || !labels.length) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    labelTargetPos = {</span>
      x: labelTarget.x,
      y: labelTarget.y
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (labelTarget.waypoints) {</span>
<span class="cstat-no" title="statement not covered" >      labelTargetPos = labelTarget.waypoints[0];</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    forEach(labels, function(label) <span class="fstat-no" title="function not covered" >{</span></span>
<span class="cstat-no" title="statement not covered" >      newPosition = {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      modeling.moveShape(label, newPosition, labelTarget.parent);</span>
    });
  });
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!source || !target) {
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!canPaste) {
    return null;
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  removeProperties(element, [</span>
    'id',
    'parent',
    'delta',
    'source',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  connection = modeling.createConnection(source, target, element, parent);</span>
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!canPaste) {
<span class="cstat-no" title="statement not covered" >    return null;</span>
  }
&nbsp;
