...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/copy-paste/CopyPaste.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/copy-paste/</a> CopyPaste.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (element.parent) {
      descriptor.parent = element.parent.id;
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (element.labelTarget) {
      // Labels priority
<span class="cstat-no" title="statement not covered" >      descriptor.priority = 4;</span>
<span class="cstat-no" title="statement not covered" >      descriptor.labelTarget = element.labelTarget.id;</span>
    }
&nbsp;
    if (element.host) {
...
&nbsp;
  if (!isArray(selectedElements)) {
    selectedElements = selectedElements ? [ selectedElements ] : <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!selectedElements.length) {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (element.labelTarget) {
<span class="cstat-no" title="statement not covered" >        labelTarget = find(elements, matchPattern({ id: element.labelTarget }));</span>
&nbsp;
        // just grab the delta from the first waypoint
<span class="cstat-no" title="statement not covered" >        if (labelTarget.waypoints) {</span>
<span class="cstat-no" title="statement not covered" >          delta = posDelta(element, labelTarget.waypoints[0]);</span>
        } else {
<span class="cstat-no" title="statement not covered" >          delta = posDelta(element, labelTarget);</span>
        }
&nbsp;
      } else
...
&nbsp;
  var tree = clipboard.get(),
      ...
      newTree, canPaste;
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (clipboard.isEmpty()) {
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (isNaN(depth)) {
<span class="cstat-no" title="statement not covered" >      return pasteTree;</span>
    }
&nbsp;
...
&nbsp;
&nbsp;
CopyPaste.prototype._computeDelta = function(elements, element) <span class="fstat-no" title="function not covered" >{</span>
  var bbox = <span class="cstat-no" title="statement not covered" >this._bbox,</span>
      delta = <span class="cstat-no" title="statement not covered" >{};</span>
&nbsp;
  // set label's relative position to their label target
<span class="cstat-no" title="statement not covered" >  if (element.labelTarget) {</span>
<span class="cstat-no" title="statement not covered" >    return posDelta(element, element.labelTarget);</span>
  }
&nbsp;
  // connections have prority 3
<span class="cstat-no" title="statement not covered" >  if (element.priority === 3) {</span>
<span class="cstat-no" title="statement not covered" >    delta = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    forEach(element.waypoints, function(waypoint) <span class="fstat-no" title="function not covered" >{</span></span>
      var waypointDelta = <span class="cstat-no" title="statement not covered" >posDelta(waypoint, bbox);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      delta.push(waypointDelta);</span>
    });
  } else {
<span class="cstat-no" title="statement not covered" >    delta = posDelta(element, bbox);</span>
  }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (element.labelTarget) {
<span class="cstat-no" title="statement not covered" >    labelTarget = find(elements, matchPattern({ id: element.labelTarget.id }));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!labelTarget) {</span>
...
CopyPaste.prototype.registerDescriptor = function(descriptor) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof descriptor !== 'function') {
<span class="cstat-no" title="statement not covered" >    throw new Error('the descriptor must be a function');</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (this._descriptors.indexOf(descriptor) !== -1) {
<span class="cstat-no" title="statement not covered" >    throw new Error('this descriptor is already registered');</span>
  }
&nbsp;
...
CopyPaste.prototype._executeDescriptors = function(data) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!data.descriptor) {
    data.descriptor = {};
  }
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (element.depth &lt; data.depth) {
<span class="cstat-no" title="statement not covered" >      includedElements.splice(idx, 1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      includedElements.push(data);</span>
    }
  }
&nbsp;
&nbsp;
...
&nbsp;
            forEach(elem.labels, function(label) <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >              includeElement({</span>
                element: label,
                depth: depth
              });
            });
...
&nbsp;
    ...
    forEach(element.labels, function(label) <span class="fstat-no" title="function not covered" >{</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      includeElement({</span>
        element: label,
        depth: depth
