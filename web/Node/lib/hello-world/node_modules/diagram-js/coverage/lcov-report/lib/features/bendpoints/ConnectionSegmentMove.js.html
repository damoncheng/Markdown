...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/bendpoints/ConnectionSegmentMove.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/bendpoints/</a> ConnectionSegmentMove.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!direction) {
...
&nbsp;
  eventBus.on('connectionSegment.move.hover', function(e) <span class="fstat-no" title="function not covered" >{</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    e.context.hover = e.hover;</span>
<span class="cstat-no" title="statement not covered" >    canvas.addMarker(e.hover, MARKER_CONNECT_HOVER);</span>
  });
&nbsp;
  eventBus.on([
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (hover) {
<span class="cstat-no" title="statement not covered" >      canvas.removeMarker(hover, MARKER_CONNECT_HOVER);</span>
    }
  });
&nbsp;
