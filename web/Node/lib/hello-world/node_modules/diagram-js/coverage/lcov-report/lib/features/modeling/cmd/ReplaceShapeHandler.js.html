...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/modeling/cmd/ReplaceShapeHandler.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/features/modeling/cmd/</a> ReplaceShapeHandler.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (allowed) {
