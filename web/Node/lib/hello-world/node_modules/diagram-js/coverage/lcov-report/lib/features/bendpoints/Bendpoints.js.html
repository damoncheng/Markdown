...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/bendpoints/Bendpoints.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/bendpoints/</a> Bendpoints.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">94.02% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>110/117</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (idx &lt;= 0 || intersection.bendpoint) {
...
&nbsp;
    var gfx = getBendpointsContainer(connection);
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (gfx) {
...
&nbsp;
  eventBus.on('connection.remove', function(event) <span class="fstat-no" title="function not covered" >{</span>
    var gfx = <span class="cstat-no" title="statement not covered" >getBendpointsContainer(event.element);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (gfx) {</span>
<span class="cstat-no" title="statement not covered" >      svgRemove(gfx);</span>
    }
  });
&nbsp;
...
&nbsp;
    var element = event.element,
        ...
        intersection;
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (waypoints) {
      bendpointsGfx = getBendpointsContainer(element, true);
      floating = domQuery('.floating', bendpointsGfx);
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!floating) {
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
      intersection = getConnectionIntersection(waypoints, event.originalEvent);
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (intersection) {
...
&nbsp;
    var originalEvent = event.originalEvent,
        ...
        waypoints = element.waypoints;
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!waypoints) {
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
...
&nbsp;
  eventBus.on('element.hover', function(event) {
    var element = event.element;
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (element.waypoints) {
      addHandles(element);
      interactionEvents.registerEvent(event.gfx, 'mousemove', 'element.mousemove');
    }
  });
&nbsp;
  eventBus.on('element.out', function(event) <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >    interactionEvents.unregisterEvent(event.gfx, 'mousemove', 'element.mousemove');</span>
  });
&nbsp;
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (bendpointContainer) {
