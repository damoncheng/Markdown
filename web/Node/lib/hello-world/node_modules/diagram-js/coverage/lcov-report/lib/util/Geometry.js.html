...
<html lang="en">
<head>
    <title>Code coverage report for lib/util/Geometry.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/util/</a> Geometry.js
    </h1>
    <div class='clearfix'>
...
export function pointInRect(p, rect, tolerance) {
  tolerance = tolerance || <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
&nbsp;
