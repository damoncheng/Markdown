...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/bendpoints/BendpointMove.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/bendpoints/</a> BendpointMove.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">92.59% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>100/108</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (e.hover) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (connectionDocking) {
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (context.hover) {</span>
<span class="cstat-no" title="statement not covered" >        if (moveType === COMMAND_RECONNECT_START) {</span>
<span class="cstat-no" title="statement not covered" >          source = context.hover;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (moveType === COMMAND_RECONNECT_END) {</span>
<span class="cstat-no" title="statement not covered" >          target = context.hover;</span>
        }
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      connection.waypoints = connectionDocking.getCroppedWaypoints(connection, source, target);</span>
    }
&nbsp;
    // add dragger gfx
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (allowed !== false &amp;&amp; context.type === COMMAND_BENDPOINT_UPDATE) {
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      redrawConnection(e);</span>
&nbsp;
