...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/snapping/Snapping.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/snapping/</a> Snapping.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (event.originalEvent &amp;&amp; event.originalEvent.ctrlKey) {
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (isSnapped(event)) {
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
    self.snap(event);
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!snapping[axis]) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (snapping.x &amp;&amp; snapping.y) {
