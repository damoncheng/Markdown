...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/auto-resize/AutoResize.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/auto-resize/</a> AutoResize.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import inherits from 'inherits';
&nbsp;
...
&nbsp;
  this.postExecuted([ 'shape.create' ], function(event) {
    var context = event.context,
        hints = context.hints,
        shape = context.shape,
        parent = context.parent || <span class="branch-1 cbranch-no" title="branch not covered" >context.newParent;</span>
&nbsp;
...
&nbsp;
  this.postExecuted([ 'elements.move' ], function(event) {
    var context = event.context,
        ...
        hints = context.hints;
&nbsp;
    var autoResize = hints ? hints.autoResize : <span class="branch-1 cbranch-no" title="branch not covered" >true;</span>
&nbsp;
    if (autoResize === false) {
      return;
    }
 ...
 */
AutoResize.prototype.getOffset = function(shape) <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >  return { top: 60, bottom: 60, left: 100, right: 100 };</span>
};
&nbsp;
&nbsp;
/**
