...
<html lang="en">
<head>
    <title>Code coverage report for lib/navigation/zoomscroll/ZoomScroll.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/navigation/zoomscroll/</a> ZoomScroll.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
&nbsp;
ZoomScroll.prototype.reset = function reset() <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >  this._canvas.zoom('fit-viewport');</span>
};
&nbsp;
/**
...
&nbsp;
    ...
    domEvent[newEnabled ? 'bind' : <span class="branch-1 cbranch-no" title="branch not covered" >'unbind']</span>(element, 'wheel', handleWheel, false);
  }
&nbsp;
