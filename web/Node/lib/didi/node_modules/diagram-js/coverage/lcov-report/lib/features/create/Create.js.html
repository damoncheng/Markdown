...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/create/Create.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/create/</a> Create.js
    </h1>
    <div class='clearfix'>
...
289
290
291</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var LOW_PRIORITY = 750;
&nbsp;
...
&nbsp;
    if (connect) {
      ...
      shape = modeling.appendShape(source, shape, position, target, {
        attach: attach,
        connection: connect === true ? {} : <span class="branch-1 cbranch-no" title="branch not covered" >connect</span>
      });
    } else {
...
&nbsp;
  eventBus.on('create.cleanup', function(event) {
    var context = event.context;
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (context.visual) {
