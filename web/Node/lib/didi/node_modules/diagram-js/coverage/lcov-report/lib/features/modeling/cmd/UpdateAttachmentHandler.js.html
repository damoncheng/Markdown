...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/modeling/cmd/UpdateAttachmentHandler.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/features/modeling/cmd/</a> UpdateAttachmentHandler.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!attachers) {
