...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/connect/Connect.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/connect/</a> Connect.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    var sourcePath = graphicsFactory.getShapePath(source),
        targetPath = target &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >graphicsFactory.getShapePath(target),</span>
        connectionPath = graphicsFactory.getConnectionPath({ waypoints: [ start, end ] });
&nbsp;
    start = getElementLineIntersection(sourcePath, connectionPath, true) || start;
    end = (target &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >getElementLineIntersection(targetPath, connectionPath, false))</span> || end;
&nbsp;
    return [ start, end ];
  }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof canExecute === 'object') {
      attrs = canExecute;
    }
&nbsp;
