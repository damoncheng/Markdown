...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/move/MovePreview.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/move/</a> MovePreview.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (addMarker) {
      canvas.addMarker(element, MARKER_DRAGGING);
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (context.allDraggedElements) {
      context.allDraggedElements.push(element);
    } else {
<span class="cstat-no" title="statement not covered" >      context.allDraggedElements = [ element ];</span>
    }
  }
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!allDraggedElements) {
      allDraggedElements = getAllDraggedElements(dragShapes);
    } else {
<span class="cstat-no" title="statement not covered" >      allDraggedElements = flatten([</span>
        allDraggedElements,
