...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/attach-support/AttachSupport.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/attach-support/</a> AttachSupport.js
    </h1>
    <div class='clearfix'>
...
function getAttachers(shapes) {
  return flatten(map(shapes, function(s) {
    return s.attachers || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
  }));
}
&nbsp;
/**
