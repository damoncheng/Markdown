...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/popup-menu/PopupMenu.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/popup-menu/</a> PopupMenu.js
    </h1>
    <div class='clearfix'>
...
443
444
445</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  var headerEntries = current.headerEntries || [],
      entries = current.entries || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (entry.action) {
...
<span class="cstat-no" title="statement not covered" >    throw new Error('entry not found');</span>
  }
&nbsp;
  return entry;
};
...
&nbsp;
  // Event handler
  domDelegate.bind(container, '.entry' ,'click', function(event) <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >    self.trigger(event);</span>
  });
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (overAxis.x &amp;&amp; overAxis.y) {
<span class="cstat-no" title="statement not covered" >    left = cursorPosition.x - containerWidth + 'px';</span>
<span class="cstat-no" title="statement not covered" >    top = cursorPosition.y - containerHeight + 'px';</span>
  } else if (overAxis.x) {
    ...
    top = 10 + 'px';
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (overAxis.y) {
    left = cursorPosition.x + 'px';
...
<span class="cstat-no" title="statement not covered" >    entryContainer.title = entry.title;</span>
  }
&nbsp;
...
&nbsp;
  var eventBus = this._eventBus,
      self = this;
&nbsp;
  function close() <span class="fstat-no" title="function not covered" >{</span>
