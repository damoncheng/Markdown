...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/resize/ResizeHandles.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/resize/</a> ResizeHandles.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  function startResize(event) <span class="fstat-no" title="function not covered" >{</span>
    // only trigger on left mouse button
<span class="cstat-no" title="statement not covered" >    if (isPrimaryButton(event)) {</span>
<span class="cstat-no" title="statement not covered" >      resize.activate(event, element, direction);</span>
    }
  }
&nbsp;
