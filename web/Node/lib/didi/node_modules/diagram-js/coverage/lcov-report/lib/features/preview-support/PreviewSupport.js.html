...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/preview-support/PreviewSupport.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/preview-support/</a> PreviewSupport.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (gfx.children) {
&nbsp;
<span class="cstat-no" title="statement not covered" >    forEach(gfx.children, function(child) <span class="fstat-no" title="function not covered" >{</span></span>
&nbsp;
      // recursion
<span class="cstat-no" title="statement not covered" >      removeMarkers(child);</span>
&nbsp;
    });
&nbsp;
  }
