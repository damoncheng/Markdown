...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/selection/Selection.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/selection/</a> Selection.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  if (add) {
    forEach(elements, function(element) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (selectedElements.indexOf(element) !== -1) {
        // already selected
