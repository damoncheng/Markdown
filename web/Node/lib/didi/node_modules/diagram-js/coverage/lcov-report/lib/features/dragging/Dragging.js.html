...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/dragging/Dragging.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/dragging/</a> Dragging.js
    </h1>
    <div class='clearfix'>
...
548
549
550</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* global TouchEvent */
&nbsp;
...
&nbsp;
    // default integration
    <span class="missing-if-branch" title="if path not taken" >I</span>if (eventBus.fire('drag.' + type, event) === false) {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!context.keepSelection) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (context.active) {
&nbsp;
...
&nbsp;
  function checkCancel(event) <span class="fstat-no" title="function not covered" >{</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (event.which === 27) {</span>
<span class="cstat-no" title="statement not covered" >      preventDefault(event);</span>
&nbsp;
...
&nbsp;
  function trapTouch(event) <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >    move(event);</span>
  }
&nbsp;
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (originalEvent.type === 'dragstart') {
<span class="cstat-no" title="statement not covered" >        preventDefault(originalEvent);</span>
      }
    } else {
      originalEvent = null;
      globalStart = { x: 0, y: 0 };
...
&nbsp;
      // add dom listeners
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (isTouch) {
<span class="cstat-no" title="statement not covered" >        domEvent.bind(document, 'touchstart', trapTouch, true);</span>
<span class="cstat-no" title="statement not covered" >        domEvent.bind(document, 'touchcancel', cancel, true);</span>
<span class="cstat-no" title="statement not covered" >        domEvent.bind(document, 'touchmove', move, true);</span>
<span class="cstat-no" title="statement not covered" >        domEvent.bind(document, 'touchend', end, true);</span>
      } else {
