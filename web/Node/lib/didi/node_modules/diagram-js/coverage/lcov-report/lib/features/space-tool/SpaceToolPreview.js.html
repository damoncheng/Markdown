...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/space-tool/SpaceToolPreview.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/space-tool/</a> SpaceToolPreview.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">96.55% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>112/116</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (crosshairGroup) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!context.dragGroup) {
...
&nbsp;
        forEach(resizingShapes, function(shape) {
          forEach(shape.outgoing, function(connection) <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            if (element === connection) {</span>
<span class="cstat-no" title="statement not covered" >              sourceIsResizing = true;</span>
            }
          });
        });
&nbsp;
...
&nbsp;
        forEach(resizingShapes, function(shape) {
          forEach(shape.incoming, function(connection) <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            if (element === connection) {</span>
<span class="cstat-no" title="statement not covered" >              targetIsResizing = true;</span>
            }
          });
        });
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!context.frameGroup) {
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (frame.initialHeight + delta.y &gt; 5) {
