...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/label-support/LabelSupport.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/label-support/</a> LabelSupport.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!label.hidden &amp;&amp; context.shapes.indexOf(label) === -1) {
          labels.push(label);
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (element.labelTarget) {
<span class="cstat-no" title="statement not covered" >          labels.push(element);</span>
        }
      });
    });
&nbsp;
