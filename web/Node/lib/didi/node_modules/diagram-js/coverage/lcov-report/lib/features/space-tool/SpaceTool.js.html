...
<html lang="en">
<head>
    <title>Code coverage report for lib/features/space-tool/SpaceTool.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/features/space-tool/</a> SpaceTool.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!event.hover &amp;&amp; !(target instanceof SVGElement)) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!context.initialized) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!context.initialized) {
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
...
&nbsp;
SpaceTool.prototype.toggle = function() <span class="fstat-no" title="function not covered" >{</span>
